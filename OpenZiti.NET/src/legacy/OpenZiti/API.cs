...
namespace OpenZiti.legacy {
    ...
    public class API {
        ...
        public static UVLoop DefaultLoopd { get; } = new UVLoop() { 
            nativeUvLoop = Native.API.z4d_new_loop()
        };
        ...
        public static void Run() {
            Native.API.z4d_uv_run(DefaultLoopd.nativeUvLoop);
        }
    }
