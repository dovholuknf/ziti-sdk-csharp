...
ler
    is offline or did not respond to the request*/
        _ziti_CONTROLLER_UNAVAILABLE, /** The SDK cannot send data to the Ziti Network because an Edge Router was not available. Common causes are:
re:
    * the identity connecting is not associated with any Edge Routers
    * the Edge Router in use is no longer responding */
        _ziti_GATEWAY_UNAVAILABLE, /** The SDK cannot send data to the Ziti Network because the requested service was not available. Common causes are:
re:
...
ler
    is offline or did not respond to the request*/
        [Description("Ziti Controller is not available")] CONTROLLER_UNAVAILABLE = -err._ziti_CONTROLLER_UNAVAILABLE, /** The SDK cannot send data to the Ziti Network because an Edge Router was not available. Common causes are:
re:
    * the identity connecting is not associated with any Edge Routers
    * the Edge Router in use is no longer responding */
        [Description("Ziti Edge Router is not available")] GATEWAY_UNAVAILABLE = -err._ziti_GATEWAY_UNAVAILABLE, /** The SDK cannot send data to the Ziti Network because the requested service was not available. Common causes are:
re:
    * the service does not exist
    * the identity connecting is not associated with the given service
    */
